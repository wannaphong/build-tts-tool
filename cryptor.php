<?php
error_reporting (E_ALL ^ E_NOTICE); // ปิดคำเตือน
...
class Cryptor {
    ...
    static private $secret_key = 'keyallttsokokkkunkc61'; // change this! (this value is used if secret_key is not passed as argument) 
