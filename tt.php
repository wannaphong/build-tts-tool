 ...
 <td>';
    ...
    if($data["is_use"]){
	 //echo "ใช้";
	     ...
	     $listall.="<a href='updateuse.php?id=".$idpost."&idpost=".$data["id"]."'>เปลี่ยน</a>";
 }
 $listall.="</td>
</tr>";
  }
  ...
  $listall.='<script src="https://cdn.plyr.io/3.3.21/plyr.js"></script>
...
var fd=new FormData();
fd.append("audio_data",blob,"'.$idpost.'.wav");
...
$tpl->set('name', 'อัดเสียง : '.$post["txt_read"]);
$tpl->set('web', $web);
$tpl->set('content', $listall);
$tpl->set('menu-1',$menu1);
$tpl->set('login-out',$menulogout);
$tpl->set('head','<link rel="stylesheet" type="text/css" href="style.css">');
